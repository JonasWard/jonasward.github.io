...
export const napoliSotterana: ProjectData = {
  ...
  projectContent: [
    ...
    ]),
    {
      ...
      images: [imageCortile, imageMonastery].map((i) => createImage(i, '©️ J.W.')),
    },
    createImage(imageDecumani, '©️ J.W.'),
    createText(
      2,
    ...
    {
      type: ProjectContentType.ImageGrid,
      images: [mapDucaDiNoja, mapIleDansLesIlos].map((i) => createImage(i, '©️ J.W.')),
    },
    createText(
      1,
