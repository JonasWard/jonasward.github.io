...
export const lucernaeTurici: ProjectData = {
  ...
  projectContent: [
    ...
    },
    {
      ...
      images: [projectImage, lamp1, lamp2, lamp3].map((i) => createImage(i, '© J.W.'))
    },
    ...
    {
      type: ProjectContentType.ImageGrid,
      images: [group1, group2].map((i) => createImage(i, '© J.W.'))
    },
    {
      type: ProjectContentType.ImageGrid,
      images: [form3, form4, form5, form6].map((i) => createImage(i, '© J.W.'))
    },
    createText(1, [
      'Post Processing',
    ...
    {
      type: ProjectContentType.ImageGrid,
      images: [group3, group4].map((i) => createImage(i, '© J.W.'))
    },
    {
      type: ProjectContentType.ImageGrid,
      images: [form7, form8, form9, form10, form11, form12, form13, form20, form21, form22].map((i) =>
        createImage(i, '© J.W.')
      )
    },
    createText(1, [
    ...
    {
      type: ProjectContentType.ImageGrid,
      images: [viewa, viewb, viewc].map((i) => createImage(i, '© J.W.'))
    },
    {
      type: ProjectContentType.ImageGrid,
      images: [print1, print2, print4, print5].map((i) => createImage(i, '© J.W.'))
    },
    {
      type: ProjectContentType.ImageGrid,
      images: [data1, data2].map((i) => createImage(i, '© J.W.'))
    }
  ]
};
