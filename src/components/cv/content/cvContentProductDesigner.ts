...
export const CVContent: CVData = {
  cvName: 'CV-compact',
  tagline: [
    'Computational Product Designer',
    'Circular and computational design across architecture, product design and fabrication.',
    'Hands-on experience spanning research, prototyping and production across CH, DE, BE, DK.'
  ],
  info: {
    name: 'Van den Bulcke',
    ...
    },
    {
      ...
      projects: {
        'circretes Digital Toolchain':
          'Advising Copenhagen-based structural concrete-reuse start-up on technical strategy and data-pipeline architecture.'
      }
    },
    {
      company: 'Jonas Ward',
      ...
      projects: {
        ...
        Scarves: [
          ...
          '2022 — Designed a scarf pattern generator and fabricated a series of scarves.'
        ],
        'SDF-lamps': [
          'https://jonasward.ch/#/project/sdf-lamps',
          '2024 — Minimalist lamp configurator to create lamp shades for existing lamp bases.'
        ],
        'Boekentoren Lamp': [
          'https://jonasward.ch/#/project/boekentoren-lamp',
          '2016 — Designed a lamp for the Boekentoren in Gent.'
        ]
      }
    }
  ],
  skills: [
    ...
    },
    {
      ...
      subSkills: {
        ...
        CAD: ['Rhino', 'Grasshopper', 'Fusion 360', 'Blender', 'AutoCAD', 'Revit'],
        Visualization: ['Illustrator', 'Photoshop', 'Figma', 'InDesign']
      }
    },
    {
      header: 'Fabrication',
      subSkills: {
        ...
        Materials: ['Clay', 'Concrete', 'Wood', 'Glass', 'PLA', 'PETG']
      }
    },

    {
      header: 'Design Technology',
      subSkills: {
        Programming: ['TypeScript', 'Python', 'WebGL', 'OpenCV'],
        Generative: ['Geometry Processing', 'SDF Modelling', 'Procedural Design']
      }
    }
  ],
  extraCurricular: {
